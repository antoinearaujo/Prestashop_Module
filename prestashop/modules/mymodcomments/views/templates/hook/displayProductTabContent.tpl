<button data-toggle="collapse" class="btn-danger" data-target="#test">Voir les avis</button>
...
<div id="test" class="collapse">
    ...
    <button data-toggle="collapse" class="btn-danger" data-target="#add">Ajouter un avis</button>
